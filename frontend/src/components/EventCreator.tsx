...
import { CreateEventRequest, EventVideo } from '../types/events';
...
export default function EventCreator({ onCancel, onSuccess }: EventCreatorProps) {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span>{createEvent.isPending ? 'Saving...' : 'Save as Draft'}</span>
            </button>
            ...
            >
              ...
              <span>{createEvent.isPending ? 'Publishing...' : 'Publish Event'}</span>
            </button>
          </div>
        </div>
      </form>
